...
void DefaultMenuView::lay_out_menu(const SubMenuState& menu, float max_width, float max_height, BoundingRect* rect) {
...
void DefaultMenuView::render(const SubMenuState& menu, const BoundingRect& rect, int selected_item_index) {
    render_background(menu, rect, selected_item_index);
...
void DefaultMenuView::render_background(const SubMenuState& menu, const BoundingRect& rect, int selected_item_index) {
    // Menu shadow
